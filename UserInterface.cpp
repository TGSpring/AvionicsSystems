...
void UserInterface::fetchAndDisplayGPSData() {
    int result = system("python C:\\Users\\tyler\\source\\repos\\newAS\\AvionicsSystems\\fetch_gps_data.py");
    if (result != 0) {
...
void UserInterface::runMLAnalysis(const SensorSim& ss, const GPSsim& gps, const WeatherSim& weather,
    ...
    std::string command = "python C:\\Users\\tyler\\source\\repos\\newAS\\AvionicsSystems\\run_ml_model.py "
