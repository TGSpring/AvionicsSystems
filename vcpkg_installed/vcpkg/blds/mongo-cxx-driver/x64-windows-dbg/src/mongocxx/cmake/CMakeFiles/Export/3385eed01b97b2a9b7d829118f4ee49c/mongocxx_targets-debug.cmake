...
set_target_properties(mongo::mongocxx_shared PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/lib/mongocxx-v_noabi-dhs-mdd.lib"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_DEBUG "mongo::mongoc_shared"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/mongocxx-v_noabi-dhs-mdd.dll"
  )

list(APPEND _cmake_import_check_targets mongo::mongocxx_shared )
list(APPEND _cmake_import_check_files_for_mongo::mongocxx_shared "${_IMPORT_PREFIX}/lib/mongocxx-v_noabi-dhs-mdd.lib" "${_IMPORT_PREFIX}/bin/mongocxx-v_noabi-dhs-mdd.dll" )
