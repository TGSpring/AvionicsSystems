...
set_target_properties(mongo::bsoncxx_shared PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/lib/bsoncxx-v_noabi-dhs-mdd.lib"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_DEBUG "mongo::bson_shared"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/bsoncxx-v_noabi-dhs-mdd.dll"
  )

list(APPEND _cmake_import_check_targets mongo::bsoncxx_shared )
list(APPEND _cmake_import_check_files_for_mongo::bsoncxx_shared "${_IMPORT_PREFIX}/lib/bsoncxx-v_noabi-dhs-mdd.lib" "${_IMPORT_PREFIX}/bin/bsoncxx-v_noabi-dhs-mdd.dll" )
